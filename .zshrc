...
plugins=(git sudo zsh-256color zsh-autosuggestions zsh-syntax-highlighting python)
...
alias exp="cd ~/experiments/Python/"
alias rm="rm -rf"
...
# No bell
unsetopt BEEP
# wal -i Development/dotfiles/wallpapers/01.png -q
